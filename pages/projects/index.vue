      ...
      <div class="gr-10@desktop gr-10@mobile gr-centered">
        <div class="resume">
          ...
          <div class="resume__experience">
            ...
            <div class="resume__bottom">
              <div class="external-link">
                <a href="https://github.com/Loschcode/bloodbath-app" target="_blank"><span class="link">View on Github</span> <span class="icon icon-link"></span></a>
              </div>
            </div>
            ...
            <!-- Description -->
            <p>I've always wanted to build up a native app. While learning Swift and making a very bad Beeper MVP, I discovered MeteorJS, a very promising technology, you could build up an Android / iOS / MacOS app all at once through Cordova and much more. I decided to code this small product about geolocation. If you're ever looking for your friends, you can open up Geokaliz, show your location with a green icon and your friend will be able to catch up with you via this open stream. The whole app was composed as live location system and published to the App Store, Google Play and I also made a MacOS version based in Electron.</p>
            <!-- Bottom -->
            <div class="resume__bottom">
              <div class="external-link">
                <a href="https://github.com/Loschcode/legacy-geokaliz" target="_blank"><span class="link">View on Github</span> <span class="icon icon-link"></span></a>
              </div>
            </div>
            ...
            <div class="resume__bottom">
              <div class="external-link">
                <a href="https://github.com/Loschcode/legacy-unicorn-fm" target="_blank"><span class="link">View on Github</span> <span class="icon icon-link"></span></a>
              </div>
            </div>

            <p><strong>I've got many other past projects, but I didn't give myself time to write them up yet...</strong></p>
          </div>
          <hr />
        </div>
      </div>
